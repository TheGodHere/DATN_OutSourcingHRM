...
//                },
    ...
    dialog = $("#dialog-form-criterion").dialog({
        autoOpen: false,
        height: 300,
        width: 350,
        modal: true,
    ...
    form = dialog.find("form").on("submit", function(event) {
        ...
        alert(document.getElementById("formCriterionTitle").getAttribute("value"));
//                addUser();
    });
...
//        target.innerHTML = targetContent.innerHTML;
    ...
    $("#criterionSaveBtn").on("click", function() {
        ...
        var target = document.getElementById("title" + nameX);
        var targetContent = document.getElementById("formCriterionTitle");
        target.innerHTML = targetContent.getAttribute("value");
//        alert(targetContent.getAttribute("value"));
//        target.innerHTML = targetContent.innerHTML;

<html lang="en"><head>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse  ">
                    <ul class="nav navbar-nav" style="float: right; text-emphasis-color: white">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Welcome, Hoang<span class="caret"></span></a>
        ...
        <div style="background-color: black">
            ...
            <nav style="width: 90%; margin-left: 5%">
            ...
            <div class="panel panel-default" style="height: 500; background-color: white;
                 margin-top: 30; margin-left: 5%; margin-right: 5%">
